            ...
            <header className={"priceStyle"} ref={(header) => {
                ...
                <div className="content">
                    ...
                    <div className={"wrapper"}>
                        <PriceBlock isActive={false} img={'price/Android.png'} text={"Android App"} alt={"android"} hash={'1'}/>
                        <PriceBlock isActive={true} img={'price/Web.png'} text={"Website"} alt={"website"} hash={'2'}/>
                        <PriceBlock isActive={false} img={'price/IOS.png'} text={"IOS App"} alt={"ios"} hash={'3'}/>
                    </div>
                    <p className={'additionalBlocks'} ref={(p) => {
                        this.addButton = p;
                    }}>Design Features</p>
